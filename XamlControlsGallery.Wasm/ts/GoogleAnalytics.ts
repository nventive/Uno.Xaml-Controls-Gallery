namespace Uno.UI.Demo {
	export class Analytics {
		...
		public static reportPageView(screenName: string, appName: string = "Uno.XamlControlsGallery"): string {
	...
	gtag("event", "screen_view", {screen_name: \"${screenName}\", app_name: \"${appName}\"});`;
			...
			script1.src = "https://www.googletagmanager.com/gtag/js?id=UA-26688675-12";
